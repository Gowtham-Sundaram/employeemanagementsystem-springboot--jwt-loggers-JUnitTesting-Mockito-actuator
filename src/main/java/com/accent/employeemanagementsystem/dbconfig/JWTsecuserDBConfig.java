package com.accent.employeemanagementsystem.dbconfig;
...
@EnableJpaRepositories(entityManagerFactoryRef = "tertiaryEntityManagerFactory", transactionManagerRef = "tertiaryTransactionManager", basePackages = {
		"com.accent.employeemanagementsystem.userrepository" })
@EntityScan(basePackages = { "com.accent.employeemanagementsystem" })
public class JWTsecuserDBConfig {
	...
	public LocalContainerEntityManagerFactoryBean tertiaryEntityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(tertiaryDataSource).packages("com.accent.employeemanagementsystem.jwtuserentitydao")
				.build();
	}
